...
\begin{tikzpicture}[scale=1,every text node part/.style={align=left}]
  ...
  \node [anchor=east] (l1) at (3.65,-.29) {($1,\,5$)};
  \node [anchor=east] (l2) at (13.15,-1.13) {(2)};
  \node [anchor=east] (l3) at (13.15,-4.09) {(3)};
  \node [anchor=east] (l4) at (3.65,-1.97) {(4)};
  \node [anchor=east] (l6) at (13.15,-2.39) {(6)};
