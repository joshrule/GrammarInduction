...
%%   \end{tikzpicture}};
  ...
  \begin{tikzpicture}
    \node (N0) at (0,2.4) {Number(six hundred thirty seven)\\1};
    \node (P1) at (-2.5,1.2) {Prefix(six, hundred)\\2};
    \node (S1) at (3,1.2) {Suffix(hundred, thirty seven)\\3};
    \node (O2) at (-2.5,0) {Ones(six).\\};
    \node (LB2) at (1.25,0) {LargerBase(hundred, $\varnothing$).\\4};
    \node (N2) at (5.75,0) {Number(thirty seven)\\5};
    \node (P3) at (7.5,-1.2) {Suffix($\varnothing$, $\varnothing$).};
    \node (S3) at (4.5,-1.2) {Prefix(thirty seven, $\varnothing$)\\6};
    \node (D3) at (3.,-2.4) {Decades(thirty).};
    \node (O3) at (6.,-2.4) {Ones(seven).};
    \node (PB3) at (0,-1.2) {PrevBase(hundred, $\varnothing$).};
