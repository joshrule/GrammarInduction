...
completely defines \emph{fifty-two}. The definition is in fact heavily
...
tokens in the grammar. {\bf THEORY-THEORY and how all concepts are
  defined as relations between entities?}
